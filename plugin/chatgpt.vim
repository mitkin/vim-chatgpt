...
function! GenerateCommitMessage()
  ...
  " Send the yanked text to ChatGPT
  let yanked_text = @@
  let prompt = 'I have the following code changes, can you write a helpful commit message, including a short title? Use a single sentence for the title, do not include the word title.\n' . yanked_text
  call ChatGPT(prompt)
